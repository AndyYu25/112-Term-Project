#cmu_112_graphics IS CITED CODE DOWNLOADED FROM https://www.diderot.one/course/34/chapters/2847/
# cmu_112_graphics.py
# version 0.8.7
...
#ADDED LAST TO IMPORT LINE
from tkinter import (
    messagebox, simpledialog, filedialog,
    Canvas, Event, Tk, BOTH, YES, ALL, LAST
)
#from tkinter import * #new change
